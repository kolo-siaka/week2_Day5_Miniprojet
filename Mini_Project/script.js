...
function playTheGame(){
    ...
    let i = confirm("Would you like to play ?")
    ...
    if(i==false){
        ...
        while(true){
            ...
            if(isNaN(userNumber)==true){
                ...
                alert("desolate, is not a good number, see you")
                ...
                let countN = Math.floor(Math.random()*10)
                 console.log(countN)
            
                isqual(userNumber, countN)
     }
...
function isqual(userNumber,countN){

   let cpt = 0

   while(cpt < 3){
        if(userNumber == countN){ 

            alert("Winner") 
            return;
       
        }                
        else if(userNumber > countN){
            alert("Your number is most high!")
            userNumber = prompt("Come again :");
        } else {
            alert("You Enter a slow number ");
            userNumber = prompt("Come again :");
        }
        cpt++
